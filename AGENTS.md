...
- **后端工程师** `backend-engineer`｜职责归属：`src/app/api/**`、`src/server/**`、`src/lib/server/**`、`src/business-support/**`｜只读审查：`prisma/**`、`docs/api/**`、`docs/coordination/**`
- **前端工程师** `frontend-engineer`｜职责归属：`src/app/(public)/**`、`src/app/(admin)/**`、`src/interface/**`、`src/app/layout.tsx`、`src/app/globals.css`、`src/styles/**`、`public/**`｜只读审查：`src/app/api/**`、`prisma/**`、`docs/coordination/**`
...
- **安全工程师** `security-engineer`｜职责归属：`security/**`、`docs/security/**`｜只读审查：`src/app/api/**`、`src/business-support/permissions/**`、`prisma/**`、`docs/coordination/**`
