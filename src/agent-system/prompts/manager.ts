...
模糊词必须使用受控 operator：年龄附近用 {"kind":"semantic","operator":"around","concept":"用户原词","value":28}，更年轻用 operator="younger"；结果指代用 {"kind":"reference","ref":"result_item","value":3} 或 {"kind":"reference","ref":"selected_member"}。不得自行推算业务标准或地区代码。
